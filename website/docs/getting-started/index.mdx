...
title: Getting Started with xPack Meson Build
...
**xPack Meson Build** is a standalone
cross-platform (Windows, macOS, GNU/Linux)binary distribution of Meson Build,
intended for reproducible builds.

<Overview/>

The open source **xPack Meson Build** project is hosted on GitHub as
...
[release assets](https://github.com/xpack-dev-tools/meson-build-xpack/releases).

In addition to the binary archives and the package metadata,
this project also includes the
[build scripts](https://github.com/xpack-dev-tools/meson-build-xpack/tree/xpack/build-assets/scripts).
...
[`meson-build-xpack.git/build-assets/scripts`](https://github.com/xpack-dev-tools/meson-build-xpack/tree/xpack/build-assets/scripts/)
...
- **Star** the project on [GitHub](https://github.com/xpack-dev-tools/meson-build-xpack/): It helps others discover our work.
