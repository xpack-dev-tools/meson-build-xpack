...
[GitHub Pages](https://xpack-dev-tools.github.io/meson-build-xpack/).

- Switch to the `xpack-development` branch
- Execute the **website-generate-commons** npm script in the `website/package.json`
  ```sh
  npm --prefix ~/Work/xpack-dev-tools/meson-build-xpack.git/website run website-generate-commons
  ```
- **Commit** all changes
