...
(such as **1.7.2-1.1**) with the following expression:
...
tagged such as **v1.7.2-1** (mind the dash in the middle!) and
named such as **xPack Meson Build v1.7.2-1** (mind the dash),
...
- **Commit** all changes with the message
  _**package.json: update URLs for 1.7.2-1.1 release**_
