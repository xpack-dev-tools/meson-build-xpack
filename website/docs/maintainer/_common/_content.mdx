...
(such as **1.6.1-1.1**) with the following expression:
...
tagged such as **v1.6.1-1** (mind the dash in the middle!) and
named such as **xPack Meson Build v1.6.1-1** (mind the dash),
