...
and fix them; assign them to a milestone (like <code>1.6.1-1</code>).
...
- add a new entry like _**\* v1.6.1-1 prepared**_
- commit with the message _**prepare v1.6.1-1**_
...
(like **1.6.1**) with the following expression:
...
tagged like **v1.6.1-1** (mind the dash in the middle!) and
named like **xPack Meson Build v1.6.1-1** (mind the dash),
...
- commit with the message _**website: blog post release 1.6.1-1 published**_
...
- commit all changes with the message
  _**package.json: update urls for 1.6.1-1.1 release**_

### Publish on the npmjs.com server

- select the `xpack-development` branch
- check the latest commits `xpm run git-log`
- update `CHANGELOG.md`, add a line like _**\* v1.6.1-1.1 published on npmjs.com**_
- commit with the message _**CHANGELOG: publish npm v1.6.1-1.1**_
...
<CodeBlock language="sh"> {
`npm dist-tag add @xpack-dev-tools/meson-build@1.6.1-1.1 latest
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`npm unpublish @xpack-dev-tools/meson-build@1.6.1-1.1
`} </CodeBlock>
...
- open https://xpack-dev-tools.github.io/meson-build-xpack/docs/maintainer/#publish-the-website in a separate window
...
- paste the release name like _**xPack Meson Build v1.6.1-1 released**_
...
[![NPM Version](https://img.shields.io/npm/v/%40xpack-dev-tools%2Fmeson-build?color=green)](https://www.npmjs.com/package/@xpack-dev-tools/meson-build/)
[![NPM Downloads](https://img.shields.io/npm/dm/%40xpack-dev-tools%2Fmeson-build)](https://www.npmjs.com/package/@xpack-dev-tools/meson-build/)
  - all releases [![NPM Downloads](https://img.shields.io/npm/dt/%40xpack-dev-tools%2Fmeson-build)](https://www.npmjs.com/package/@xpack-dev-tools/meson-build/)
