...
upstream {props.upstreamName ? props.upstreamName : 'Meson Build'} project
is a three-number string
such as <code>1.7.2</code>;
...
such as <code>1.7.2-<b>1</b></code>. When
published as an npm package, the version receives
a fifth number,
such as <code>1.7.2-1.<b>1</b></code>.

Since adherence of third-party packages to SemVer is not guaranteed,
it is recommended to avoid referencing the xPack Meson Build dependency via
SemVer expressions
such as <code>^1.7.2-1</code> or <code>~1.7.2-1</code>, and
