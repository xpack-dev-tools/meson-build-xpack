...
title: Information for xPack Meson Build maintainers
...
```sh
bash ~/Work/xpack-dev-tools/meson-build-xpack.git/build-assets/xpacks/@xpack-dev-tools/xbb-helper/github-actions/trigger-travis-macos.sh
```
...
- <code>npm dist-tag ls @xpack-dev-tools/meson-build</code>
- <code>npm dist-tag add @xpack-dev-tools/meson-build@{ customField('upstreamVersion') }-{ customField('xpackSubversion') }.{ customField('npmSubversion') } latest</code>
- <code>npm dist-tag ls @xpack-dev-tools/meson-build</code>

In case the previous version is not functional and needs to be unpublished:

- <code>npm unpublish @xpack-dev-tools/meson-build@{ customField('upstreamVersion') }-{ customField('xpackSubversion') }.{ customField('npmSubversion') }</code>
...
- the result is in https://xpack-dev-tools.github.io/meson-build-xpack/blog/
