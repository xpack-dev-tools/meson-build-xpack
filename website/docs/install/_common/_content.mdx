...
<CodeBlock language="sh"> {
`export PATH=$HOME/AppData/Roaming/xPacks/\@pack-dev-tools/meson-build/1.6.1-1.1/.content/bin:$PATH
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/Library/xPacks/\@pack-dev-tools/meson-build/1.6.1-1.1/.content/bin:$PATH
`} </CodeBlock>
...
<li><code>xpack-meson-build-1.6.1-1-linux-arm.tar.gz</code></li>
</ul>
