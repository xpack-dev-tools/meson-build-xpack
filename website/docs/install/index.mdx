...
# How to install the xPack Meson Build
...
The command to install the **latest** available version of **meson-build** is:
...
<CodeBlock language="sh"> {
`xpm install @xpack-dev-tools/meson-build@${customField('releaseVersion')} --verbose
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/AppData/Roaming/xPacks/\@pack-dev-tools/meson-build/${customField('xpackVersion')}.${customField('npmSubversion')}/.content/bin:$PATH
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/Library/xPacks/\@pack-dev-tools/meson-build/${customField('xpackVersion')}.${customField('npmSubversion')}/.content/bin:$PATH
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/.local/xPacks/@xpack-dev-tools/meson-build/${customField('xpackVersion')}.${customField('npmSubversion')}/.content/bin:$PATH
`} </CodeBlock>
...
<ul>
<li><code>xpack-meson-build-{customField('xpackVersion')}-win32-x64.zip</code></li>
</ul>
...
example <code>C:\\Users\\ilg\\AppData\\Roaming\\xPacks\\meson-build\\xpack-meson-build-{customField('xpackVersion')}</code>.
...
<ul>
<li><code>xpack-meson-build-{customField('xpackVersion')}-darwin-x64.tar.gz</code></li>
<li><code>xpack-meson-build-{customField('xpackVersion')}-darwin-arm64.tar.gz</code></li>
</ul>
...
example <code>/Users/ilg/Library/xPacks/meson-build/xpack-meson-build-{customField('xpackVersion')}</code>:

<CodeBlock language="console"> {
`mkdir -p ~/Library/xPacks/meson-build
cd ~/Library/xPacks/meson-build

tar xvf ~/Downloads/xpack-meson-build-${customField('xpackVersion')}-darwin-x64.tar.gz
chmod -R -w xpack-meson-build-${customField('xpackVersion')}
`} </CodeBlock>
...
<ul>
<li><code>xpack-meson-build-{customField('xpackVersion')}-linux-x64.tar.gz</code></li>
<li><code>xpack-meson-build-{customField('xpackVersion')}-linux-arm64.tar.gz</code></li>
<li><code>xpack-meson-build-{customField('xpackVersion')}-linux-arm.tar.gz</code></li>
</ul>
...
example <code>/home/ilg/.local/xPacks/meson-build/xpack-meson-build-{customField('xpackVersion')}</code>:

<CodeBlock language="console"> {
`mkdir -p ~/.local/xPacks/meson-build
cd ~/.local/xPacks/meson-build

tar xvf ~/Downloads/xpack-meson-build-${customField('xpackVersion')}-linux-x64.tar.gz
chmod -R -w xpack-meson-build-${customField('xpackVersion')}
`} </CodeBlock>
