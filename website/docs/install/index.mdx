...
[![npm (scoped)](https://img.shields.io/npm/v/%40xpack-dev-tools%2Fmeson-build?label=xpm&color=blue)](https://www.npmjs.com/package/@xpack-dev-tools/meson-build/)
![GitHub Downloads (all assets, all releases)](https://img.shields.io/github/downloads/xpack-dev-tools/meson-build-xpack/total)
[![npm](https://img.shields.io/npm/dm/%40xpack-dev-tools%2Fmeson-build?label=xpm%20downloads)](https://www.npmjs.com/package/@xpack-dev-tools/meson-build/)

The **xPack Meson Build** can be installed automatically, using the `xpm` command
...
<code>xpacks/@xpack-dev-tools/meson-build</code>.
...
**meson-build** package into the project:
...
* identify the platform specific archive for the latest available version
  of Meson Build, download it into a cache and unpack
...
<CodeBlock language="sh"> {
`xpm install @xpack-dev-tools/meson-build@latest --global --verbose
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/AppData/Roaming/xPacks/\@pack-dev-tools/meson-build/${customField('upstreamVersion')}-${customField('xpackSubversion')}.${customField('npmSubversion')}/.content/bin:$PATH
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/Library/xPacks/\@pack-dev-tools/meson-build/${customField('upstreamVersion')}-${customField('xpackSubversion')}.${customField('npmSubversion')}/.content/bin:$PATH
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/.local/xPacks/@xpack-dev-tools/meson-build/${customField('upstreamVersion')}-${customField('xpackSubversion')}.${customField('npmSubversion')}/.content/bin:$PATH
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`xpm uninstall @xpack-dev-tools/meson-build --verbose
`} </CodeBlock>
...
the <a href={`https://github.com/xpack-dev-tools/meson-build-xpack/releases/`}>GitHub Releases</a> pages.
...
* <code>xpack-meson-build-{customField('upstreamVersion')}-{customField('xpackSubversion')}-win32-x64.zip</code>
...
To manually install the <b>xPack Meson Build</b>,
...
example <code>C:\\Users\\ilg\\AppData\\Roaming\\xPacks\\meson-build\\xpack-meson-build-{customField('upstreamVersion')}-{customField('xpackSubversion')}</code>.
...
* <code>xpack-meson-build-{customField('upstreamVersion')}-{customField('xpackSubversion')}-darwin-x64.tar.gz</code>
* <code>xpack-meson-build-{customField('upstreamVersion')}-{customField('xpackSubversion')}-darwin-arm64.tar.gz</code>
...
example <code>/Users/ilg/Library/xPacks/meson-build/xpack-meson-build-{customField('upstreamVersion')}-{customField('xpackSubversion')}</code>:

<CodeBlock language="console"> {
`mkdir -p ~/Library/xPacks/meson-build
cd ~/Library/xPacks/meson-build

tar xvf ~/Downloads/xpack-meson-build-${customField('upstreamVersion')}-${customField('xpackSubversion')}-darwin-x64.tar.gz
chmod -R -w xpack-meson-build-${customField('upstreamVersion')}-${customField('xpackSubversion')}
`} </CodeBlock>
...
* <code>xpack-meson-build-{customField('upstreamVersion')}-{customField('xpackSubversion')}-darwin-x64.tar.gz</code>
* <code>xpack-meson-build-{customField('upstreamVersion')}-{customField('xpackSubversion')}-darwin-arm64.tar.gz</code>
* <code>xpack-meson-build-{customField('upstreamVersion')}-{customField('xpackSubversion')}-darwin-arm.tar.gz</code>
...
example <code>/home/ilg/.local/xPacks/meson-build/xpack-meson-build-{customField('upstreamVersion')}-{customField('xpackSubversion')}</code>:

<CodeBlock language="console"> {
`mkdir -p ~/.local/xPacks/meson-build
cd ~/.local/xPacks/meson-build

tar xvf ~/Downloads/xpack-meson-build-${customField('upstreamVersion')}-${customField('xpackSubversion')}-linux-x64.tar.gz
chmod -R -w xpack-meson-build-${customField('upstreamVersion')}-${customField('xpackSubversion')}
`} </CodeBlock>
