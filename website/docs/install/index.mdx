...
<CodeBlock language="sh"> {
`export PATH=$HOME/AppData/Roaming/xPacks/\@pack-dev-tools/meson-build/1.5.2-1.1/.content/bin:$PATH
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/Library/xPacks/\@pack-dev-tools/meson-build/1.5.2-1.1/.content/bin:$PATH
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/.local/xPacks/@xpack-dev-tools/meson-build/1.5.2-1.1/.content/bin:$PATH
`} </CodeBlock>
...
<ul>
<li><code>xpack-meson-build-1.5.2-1-win32-x64.zip</code></li>
</ul>
...
example <code>C:\\Users\\ilg\\AppData\\Roaming\\xPacks\\meson-build\\xpack-meson-build-1.5.2-1</code>.
...
<ul>
<li><code>xpack-meson-build-1.5.2-1-darwin-x64.tar.gz</code></li>
<li><code>xpack-meson-build-1.5.2-1-darwin-arm64.tar.gz</code></li>
</ul>
...
example <code>/Users/ilg/Library/xPacks/meson-build/xpack-meson-build-1.5.2-1</code>:

<CodeBlock language="console"> {
`mkdir -p ~/Library/xPacks/meson-build
cd ~/Library/xPacks/meson-build

tar xvf ~/Downloads/xpack-meson-build-1.5.2-1-darwin-x64.tar.gz
chmod -R -w xpack-meson-build-1.5.2-1
`} </CodeBlock>
...
<ul>
<li><code>xpack-meson-build-1.5.2-1-linux-x64.tar.gz</code></li>
<li><code>xpack-meson-build-1.5.2-1-linux-arm64.tar.gz</code></li>
<li><code>xpack-meson-build-1.5.2-1-linux-arm.tar.gz</code></li>
</ul>
...
example <code>/home/ilg/.local/xPacks/meson-build/xpack-meson-build-1.5.2-1</code>:

<CodeBlock language="console"> {
`mkdir -p ~/.local/xPacks/meson-build
cd ~/.local/xPacks/meson-build

tar xvf ~/Downloads/xpack-meson-build-1.5.2-1-linux-x64.tar.gz
chmod -R -w xpack-meson-build-1.5.2-1
`} </CodeBlock>
