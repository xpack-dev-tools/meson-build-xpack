...
const config: Config = {
  title: 'xPack Meson Build',
  tagline: 'A binary distribution of Meson Build',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/xpack-dev-tools/meson-build-xpack/edit/xpack/website/',
        ...
        sitemap: {
          ...
          priority: 0.5,
          ignorePatterns: [
            '/meson-build-xpack/blog/archive/**',
            '/meson-build-xpack/blog/authors/**',
            '/meson-build-xpack/blog/tags/**'
          ],
  ...
  headTags: [
    {
      ...
      attributes: {
        rel: 'icon',
        type: 'image/png',
        href: '/meson-build-xpack/favicons/favicon-48x48.png',
        sizes: '48x48'
      }
    },
    {
      ...
      attributes: {
        rel: 'icon',
        type: 'image/svg+xml',
        href: '/meson-build-xpack/favicons/favicon.svg'
      }
    },
    {
      tagName: 'link',
      attributes: {
        rel: 'shortcut icon',
        href: '/meson-build-xpack/favicons/favicon.ico'
      }
    },
    {
    ...
    },
    {
      ...
      attributes: {
        rel: 'manifest',
        href: '/meson-build-xpack/favicons/site.webmanifest'
      }
    }
  ],
  ...
  themeConfig: {
    ...
    metadata: [
      {
        name: 'keywords',
        content: 'xpack, binary, development, tools, reproducibility, meson-build'
      }
    ],
    navbar: {
      ...
      items: [
        ...
        },
        {
          ...
          position: 'right',
          href: `https://github.com/xpack-dev-tools/meson-build-xpack/releases/tag/v${customFields.xpackVersion}`,
        },
      ],
    },
    footer: {
          ...
          items: [
            {
              ...
              href: 'https://github.com/xpack-dev-tools/meson-build-xpack/discussions',
            },
            {
