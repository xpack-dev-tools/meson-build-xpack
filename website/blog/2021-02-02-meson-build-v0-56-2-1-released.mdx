...
seo_title: Version 0.56.2-1 released
description: Version 0.56.2-1 is a new release of xPack Meson Build.
keywords:
  - xpack
  - meson-build
  - release
...
- [[#3](https://github.com/xpack-dev-tools/meson-build-xpack/issues/3)]:  The macOS version fails to start properly with multiple symbolic links.
