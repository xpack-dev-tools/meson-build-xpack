...
seo_title: Version 1.2.3-1 released
description: Version 1.2.3-1 is a new release of xPack Meson Build.
keywords:
  - xpack
  - meson-build
  - release
...
Version **1.2.3-1** is a new release; it follows the upstream release.
