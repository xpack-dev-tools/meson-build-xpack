...
seo_title: Version 0.55.3-2 released
description: Version 0.55.3-2 is a maintenance release of xPack Meson Build.
keywords:
  - xpack
  - meson-build
  - release
...
Version **0.55.3-2** is a maintenance release of the **xPack Meson Build** package; it fixes two bugs and updates to the new, more robust, build scripts.
