...
seo_title: Version 0.62.2-1 released
description: Version 0.62.2-1 is a new release of xPack Meson Build.
keywords:
  - xpack
  - meson-build
  - release
...
Version **0.62.2-1** is a new release; it follows the upstream release.
