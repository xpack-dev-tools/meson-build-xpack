...
The version string is an extension to semver, the format looks like `0.60.3-1`.
It includes the three digits with the original Meson version (0.60.3), a fourth
...
bash ${HOME}/Work/meson-build-xpack.git/scripts/helper/build.sh --develop --linux64 --win64
```
...
```sh
sudo rm -rf ~/Work/meson-build-*-*
bash ${HOME}/Work/meson-build-xpack.git/scripts/helper/build.sh --develop --without-html --disable-tests --linux64 --win64
```
...
total 72744
-rw-rw-r-- 1 ilg ilg 17885078 Oct 16 19:56 xpack-meson-build-0.60.3-1-linux-x64.tar.gz
-rw-rw-r-- 1 ilg ilg      110 Oct 16 19:56 xpack-meson-build-0.60.3-1-linux-x64.tar.gz.sha
-rw-rw-r-- 1 ilg ilg 19749186 Oct 16 19:56 xpack-meson-build-0.60.3-1-win32-x64.zip
-rw-rw-r-- 1 ilg ilg      107 Oct 16 19:56 xpack-meson-build-0.60.3-1-win32-x64.zip.sha
```
...
sudo rm -rf ~/Work/meson-build-*-*
bash ${HOME}/Work/meson-build-xpack.git/scripts/helper/build.sh --develop --arm64 --arm32
```
...
```sh
sudo rm -rf ~/Work/meson-build-*-*
bash ${HOME}/Work/meson-build-xpack.git/scripts/helper/build.sh --develop --without-html --disable-tests --arm64 --arm32
```
...
$ cd ~/Work/meson-build-*/deploy
total 34452
-rw-rw-r-- 1 ilg ilg 17846357 Oct 16 17:21 xpack-meson-build-0.60.3-1-linux-arm64.tar.gz
-rw-rw-r-- 1 ilg ilg      112 Oct 16 17:21 xpack-meson-build-0.60.3-1-linux-arm64.tar.gz.sha
-rw-rw-r-- 1 ilg ilg 17417308 Oct 16 18:11 xpack-meson-build-0.60.3-1-linux-arm.tar.gz
-rw-rw-r-- 1 ilg ilg      110 Oct 16 18:11 xpack-meson-build-0.60.3-1-linux-arm.tar.gz.sha
```
...
```sh
rm -rf ~/Work/meson-build-*-*
caffeinate bash ${HOME}/Work/meson-build-xpack.git/scripts/helper/build.sh --develop --without-html --disable-tests --macos
```
...
$ cd ~/Work/meson-build-*/deploy
total 33680
-rw-r--r--  1 ilg  staff  17239748 Oct 16 20:02 xpack-meson-build-0.60.3-1-darwin-x64.tar.gz
-rw-r--r--  1 ilg  staff       111 Oct 16 20:02 xpack-meson-build-0.60.3-1-darwin-x64.tar.gz.sha
```
...
```console
$ .../xpack-meson-build-0.60.3-1/bin/meson --version
0.60.3
```
...
```console
$ tree -L 2 /Users/ilg/Library/xPacks/\@xpack-dev-tools/meson-build/0.60.3-1.1/.content/
/Users/ilg/Library/xPacks/@xpack-dev-tools/meson-build/0.60.3-1.1/.content/
├── README.md
├── bin
│   └── meson
├── distro-info
