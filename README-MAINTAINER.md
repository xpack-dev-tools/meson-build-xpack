...
```sh
bash ~/Work/xpack-dev-tools/meson-build-xpack.git/xpacks/@xpack-dev-tools/xbb-helperr/github-actions/trigger-workflow-build.sh --machine xbbli
bash ~/Work/xpack-dev-tools/meson-build-xpack.git/xpacks/@xpack-dev-tools/xbb-helperr/github-actions/trigger-workflow-build.sh --machine xbbla64
bash ~/Work/xpack-dev-tools/meson-build-xpack.git/xpacks/@xpack-dev-tools/xbb-helperr/github-actions/trigger-workflow-build.sh --machine xbbla32
bash ~/Work/xpack-dev-tools/meson-build-xpack.git/xpacks/@xpack-dev-tools/xbb-helperr/github-actions/trigger-workflow-build.sh --machine xbbmi
bash ~/Work/xpack-dev-tools/meson-build-xpack.git/xpacks/@xpack-dev-tools/xbb-helperr/github-actions/trigger-workflow-build.sh --machine xbbma
```
...
```sh
bash ~/Work/xpack-dev-tools/meson-build-xpack.git/xpacks/@xpack-dev-tools/xbb-helperr/github-actions/trigger-workflow-test-prime.sh
bash ~/Work/xpack-dev-tools/meson-build-xpack.git/xpacks/@xpack-dev-tools/xbb-helperr/github-actions/trigger-workflow-test-docker-linux-intel.sh
bash ~/Work/xpack-dev-tools/meson-build-xpack.git/xpacks/@xpack-dev-tools/xbb-helperr/github-actions/trigger-workflow-test-docker-linux-arm.sh
```
...
```sh
bash ~/Work/xpack-dev-tools/meson-build-xpack.git/xpacks/@xpack-dev-tools/xbb-helperr/github-actions/trigger-travis-macos.sh
```
