...
Determine the version (like `1.2.3`) and update the `scripts/VERSION`
file; the format is `1.2.3-1`. The fourth number is the xPack release number
...
and fix them; assign them to a milestone (like `1.2.3-1`).
...
Use the new version, suffixed by `pre`, like `1.2.3-1.1.pre`.

### Update `CHANGELOG.md`

- open the `CHANGELOG.md` file
- check if all previous fixed issues are in
- add a new entry like _* v1.2.3-1 prepared_
- commit with a message like _prepare v1.2.3-1_
...
total 56512
-rw-r--r--  1 ilg  staff  28524860 Nov 25 18:35 xpack-meson-build-1.2.3-1-darwin-x64.tar.gz
-rw-r--r--  1 ilg  staff       110 Nov 25 18:35 xpack-meson-build-1.2.3-1-darwin-x64.tar.gz.sha
```
...
total 56152
-rw-r--r--  1 ilg  staff  28197515 Nov 25 18:30 xpack-meson-build-1.2.3-1-darwin-arm64.tar.gz
-rw-r--r--  1 ilg  staff       112 Nov 25 18:30 xpack-meson-build-1.2.3-1-darwin-arm64.tar.gz.sha
```
...
total 28180
-rw-r--r-- 1 ilg ilg 28851060 Nov 25 16:32 xpack-meson-build-1.2.3-1-linux-x64.tar.gz
-rw-r--r-- 1 ilg ilg      109 Nov 25 16:32 xpack-meson-build-1.2.3-1-linux-x64.tar.gz.sha
```
...
total 20748
-rw-r--r-- 1 ilg ilg 21240764 Nov 25 16:23 xpack-meson-build-1.2.3-1-win32-x64.zip
-rw-r--r-- 1 ilg ilg      106 Nov 25 16:23 xpack-meson-build-1.2.3-1-win32-x64.zip.sha
```
...
total 27912
-rw-r--r-- 1 ilg ilg 28574605 Nov 25 16:44 xpack-meson-build-1.2.3-1-linux-arm64.tar.gz
-rw-r--r-- 1 ilg ilg      111 Nov 25 16:44 xpack-meson-build-1.2.3-1-linux-arm64.tar.gz.sha
```
...
total 19924
-rw-r--r-- 1 ilg ilg 20395664 Jan 28 11:19 xpack-meson-build-1.2.3-1-linux-arm.tar.gz
-rw-r--r-- 1 ilg ilg      110 Jan 28 11:19 xpack-meson-build-1.2.3-1-linux-arm.tar.gz.sha
```
...
```sh
.../xpack-meson-build-1.2.3-1/bin/meson-build --version
1.2.3
```
...
- in `CHANGELOG.md`, add the release date and a message like _* v1.2.3-1 released_
...
tagged like **v1.2.3-1** (mind the dash in the middle!) and
named like **xPack Meson Build v1.2.3-1** (mind the dash),
...
- commit the `develop` branch of `xpack/web-jekyll` GitHub repo;
  use a message like _xPack Meson Build v1.2.3-1 released_
- push to GitHub
...
- commit all changes, use a message like
  _package.json: update urls for 1.2.3-1.1 release_ (without _v_)

## Publish on the npmjs.com server

- select the `xpack-develop` branch
- check the latest commits `npm run git-log`
- update `CHANGELOG.md`, add a line like _* v1.2.3-1.1 published on npmjs.com_
- commit with a message like _CHANGELOG: publish npm v1.2.3-1.1_
- `npm pack` and check the content of the archive, which should list
  only the `package.json`, the `README.md`, `LICENSE` and `CHANGELOG.md`;
  possibly adjust `.npmignore`
- `npm version 1.2.3-1.1`; the first 4 numbers are the same as the
...
- `npm dist-tag add @xpack-dev-tools/meson-build@1.2.3-1.1 latest`
- `npm dist-tag ls @xpack-dev-tools/meson-build`

In case the previous version is not functional and needs to be unpublished:

- `npm unpublish @xpack-dev-tools/meson-build@1.2.3-1.1`
...
- paste the release name like **xPack Meson Build v1.2.3-1 released**
