...
[![NPM Version](https://img.shields.io/npm/v/@xpack-dev-tools/meson-build?color=blue)](https://www.npmjs.com/package/@xpack-dev-tools/meson-build/)
...
distribution of Meson Build,
intended for reproducible builds.

## Project documentation

For information on how to install and use this project, please refer to the
[project website](https://xpack-dev-tools.github.io/meson-build-xpack/).

## Project source

The source code of the current release is available on
GitHub as [xpack-dev-tools/meson-build-xpack](https://github.com/xpack-dev-tools/meson-build-xpack),
the [v1.8.5-1.1](https://github.com/xpack-dev-tools/meson-build-xpack/tree/v1.8.5-1.1) tree.
