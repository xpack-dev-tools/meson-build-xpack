...
[![NPM Version](https://img.shields.io/npm/v/@xpack-dev-tools/meson-build?color=green)](https://www.npmjs.com/package/@xpack-dev-tools/meson-build/)
...
[project web site](https://xpack-dev-tools.github.io/meson-build-xpack/).

## Project source

The source code of the current release is available on
[GitHub tag v1.5.2-1.1 tree](https://github.com/xpack-dev-tools/meson-build-xpack/tree/v1.5.2-1.1).
