...
# Script to build the xPack Meson Build distribution packages.
#
# Developed on macOS 10.15 Catalina, but intended to run on
# macOS 10.10 Yosemite and Ubuntu 12 via XBB v3.2. 

# -----------------------------------------------------------------------------

echo
echo "xPack Meson Build distribution build script."
...
help_message="    bash $0 [--win32] [--win64] [--linux32] [--linux64] [--arm32] [--arm64] [--osx] [--all] [clean|cleanlibs|cleanall|preload-images] [--env-file file] [--disable-strip] [--disable-tests] [--without-pdf] [--with-html] [--develop] [--debug] [--jobs N] [--help]"
